...
/*   Updated: 2025/08/28 13:02:27 by haloztur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_simulation
{
	...
	unsigned int		must_eat_count;     /* 0 => sınırsız */
	int					someone_died;       /* 0/1 */
	unsigned long long	start_time;

	/* Senkronizasyon */
	pthread_mutex_t		*forks;             /* array size: philosopher_count */
